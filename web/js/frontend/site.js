...
jQuery('#profileButton').on('click', function(){
    jQuery('#profileModal').modal('toggle');
    return false;
});

jQuery('#forgottenButton').on('click', function(){
    jQuery('#forgottenModal').modal('toggle');
    return false;
});
...
$(function () {
    ...
    (window.onLoad || []).map(function(f) { f(); }, window);
